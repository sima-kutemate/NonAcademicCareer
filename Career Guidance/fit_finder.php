...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="career_path.php">Career Path</a>
        <a href="experts.php">Experts</a>
        <a href="study_track.php">Study Track</a>
...
<section class="footer">
    <div class="box-container">
        <div class="box">
            ...
            <a href="career_path.php"><i class="fas fa-angle-right"></i> Career Path</a>
            <a href="experts.php"><i class="fas fa-angle-right"></i> Experts</a>
            <a href="study_track.php"><i class="fas fa-angle-right"></i> Study Track</a>
